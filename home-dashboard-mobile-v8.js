(() => {
  ...
  function ensureStyle() {
    ...
    s.textContent += `.hdToday{grid-template-columns:minmax(0,1fr) 94px!important;align-items:center!important}.hdToday h3{margin-bottom:15px!important}.hdTags{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:10px!important;width:100%!important}.hdToday .hdTag{position:relative!important;display:flex!important;align-items:center!important;justify-content:space-between!important;width:100%!important;min-height:54px!important;padding:11px 12px!important;border-radius:15px!important;font-size:16px!important;line-height:1.2!important;text-align:left!important;box-shadow:0 5px 12px rgba(34,69,54,.09)!important}.hdToday .hdTag:after{content:'›';font-size:22px;color:#a17b3e;line-height:1}.hdToday .hdTag:active{transform:scale(.97);box-shadow:0 2px 6px rgba(34,69,54,.08)!important}.hdCat{margin-left:4px}@media(max-width:430px){.hdToday{grid-template-columns:minmax(0,1fr) 78px!important}.hdToday .hdTag{min-height:52px!important;padding:10px!important;font-size:15px!important}.hdCat{height:78px!important;font-size:31px!important;border-radius:18px!important}}`;
