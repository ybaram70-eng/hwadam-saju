(() => {
  ...
  function lockBox() {
    ...
    box.querySelector("button").onclick = () => $("hwadamPaidReport")?.scrollIntoView({ behavior: "smooth", block: "start" });
    return box;
  }
  function style() {
