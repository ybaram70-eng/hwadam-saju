(() => {
  ...
  function ensureStyle() {
    ...
    s.textContent += `.hdPromoFill button{min-height:310px!important;padding:26px 20px!important}.hdPromoFill span{font-size:42px!important}.hdPromoFill b{font-size:22px!important;line-height:1.45!important}.hdPromoFill small{font-size:14px!important;line-height:1.65!important}.hdPromo{padding-bottom:18px!important}@media(max-width:430px){.hdPromoFill button{min-height:290px!important;padding:24px 17px!important}.hdPromoFill span{font-size:38px!important}.hdPromoFill b{font-size:20px!important}.hdPromoFill small{font-size:13px!important}}`;
    s.textContent += `.hdYongsin{display:grid;grid-template-columns:1fr 118px;gap:14px;align-items:center;min-height:205px;margin-top:14px;padding:24px;border-radius:22px;background:linear-gradient(140deg,#315e50,#1c4639);border:1px solid #d7bb7d;color:#fff;text-decoration:none;box-shadow:0 10px 24px rgba(25,65,51,.16)}.hdYongsin small{display:inline-block;padding:6px 10px;border-radius:999px;background:#e9c77f;color:#23483b;font-size:12px;font-weight:950}.hdYongsin strong{display:block;margin:13px 0 8px;font-size:27px;line-height:1.3;color:#fff8e8}.hdYongsin p{margin:0;color:#dce9e3;font-size:15px;line-height:1.6}.hdYongsinAction{margin-top:14px;font-size:14px;font-weight:900;color:#f0d399}.hdYongsinElements{display:grid;grid-template-columns:1fr 1fr;gap:8px}.hdYongsinElements span{height:48px;border-radius:14px;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,.1);border:1px solid rgba(239,211,153,.3);font-size:24px}.hdYongsinElements span:last-child{grid-column:1/-1}@media(max-width:430px){.hdYongsin{grid-template-columns:1fr 92px;min-height:190px;padding:20px 17px}.hdYongsin strong{font-size:23px}.hdYongsin p{font-size:13px}.hdYongsinElements{gap:6px}.hdYongsinElements span{height:42px;font-size:21px}}`;
    s.textContent += `.hdDashHero{display:none!important}.hdToday{display:none!important}#hdTopicBox{display:none!important}.hdFortune{margin-top:8px!important}`;
  ...
  function ensureDashboard() {
    ...
    x.innerHTML = `<div class="hdDashHero"><div class="hdDashBrand">和談 · HWADAM PALM</div><h2>내 손에 담긴<br>삶의 흐름을 읽다</h2><p>생명선·두뇌선·감정선·운명선부터 재물선과 태양선까지 쉽게 살펴보세요.</p><div class="hdHeroActions"><button type="button" onclick="parent.location.href='/palm.html'">손금 사진 올리기</button><button type="button" onclick="parent.location.href='/palm.html'">손금 보기</button></div></div><div class="hdToday"><div><div class="hdTodayName">TODAY · 오늘의 화담</div><h3>오늘 필요한 운세를<br>선택해 보세요</h3><div class="hdTags"><button class="hdTag" data-topic="재물">재물운</button><button class="hdTag" data-topic="건강">건강운</button><button class="hdTag" data-topic="계획">계획</button><button class="hdTag" data-topic="안정">마음</button></div></div><div class="hdCat">今日</div></div><div id="hdTopicBox" class="hdTopicBox"><b id="hdTopicTitle"></b><p id="hdTopicText"></p></div><div class="hdFortune"><div><small>✦ 오늘의 안내</small><div class="hdScoreRow"><span class="hdScore">운세를 시작해 보세요</span><span class="hdBadge">간편 확인</span></div><p>출생정보 입력 후 나에게 필요한 운세를 바로 확인할 수 있습니다.</p></div><div class="hdCheck">✓</div></div><div class="hdMenu"><a target="_top" href="/palm.html"><span>🖐️</span>손금보기</a><a target="_top" href="/face.html"><span>🙂</span>관상보기</a><button data-go="input"><span>📝</span>사주입력</button><button data-go="analysis"><span>📊</span>화담분석</button><button data-go="ai"><span>💬</span>AI상담</button><button data-go="calendar"><span>🗓️</span>택일달력</button><button data-go="journal"><span>📔</span>화담일지</button><button data-go="ai" data-product="compatibility"><span>💞</span>궁합</button><a target="_top" href="/?product=annual-fortune"><span>☯️</span>${year} 신년운세</a><button data-go="journal"><span>🎁</span>이벤트</button></div><div class="hdFlow"><b>최근 에너지 흐름</b><p>사주를 계산하면 현재 대운·세운과 상담 흐름을 이어서 확인할 수 있습니다.</p></div>`;
    ...
    x.querySelector(".hdFlow").insertAdjacentHTML(
      "afterend",
      `<section class="hdPromo"><div class="hdPromoHead"><div><small>HWADAM SERVICE</small><h3>화담 상담 상품</h3></div><b>4개 상품</b></div><div class="hdPromoTabs"><button type="button" class="active" data-filter="all">전체</button><button type="button" data-filter="fortune">운세</button><button type="button" data-filter="consult">상담</button></div><div class="hdPromoTrack"><a class="hdPromoCard" data-cat="fortune" target="_top" href="/?product=annual-fortune"><div class="hdPromoVisual"><div class="hdPromoBadges"><span>NEW</span><span>연도별</span></div><strong>${year}년<br>나의 신년운세</strong></div><div class="hdPromoBody"><b>${year}년 신년운세</b><p>1년 총운과 12개월 월별 흐름을 자세히 살펴봅니다.</p><div class="hdPromoPrice">9,900원 <span>상담 선택 ›</span></div></div></a><a class="hdPromoCard" data-cat="consult" target="_top" href="/palm.html"><div class="hdPromoVisual"><div class="hdPromoBadges"><span>추천</span><span>손금</span></div><strong>내 손에 담긴<br>삶의 흐름 분석</strong></div><div class="hdPromoBody"><b>AI 손금 상세분석</b><p>손바닥 사진으로 주요 손금선과 보조선을 자세히 살펴봅니다.</p><div class="hdPromoPrice">5,900원 <span>손금 보기 ›</span></div></div></a><a class="hdPromoCard" data-cat="consult" target="_top" href="/?product=compatibility"><div class="hdPromoVisual"><div class="hdPromoBadges"><span>관계</span><span>궁합</span></div><strong>두 사람의<br>관계 흐름과 궁합</strong></div><div class="hdPromoBody"><b>궁합 상담</b><p>잘 맞는 점과 갈등을 줄이는 방법을 살펴봅니다.</p><div class="hdPromoPrice">7,900원 <span>상담 선택 ›</span></div></div></a><a class="hdPromoCard" data-cat="consult" target="_top" href="/?product=comprehensive"><div class="hdPromoVisual"><div class="hdPromoBadges"><span>BEST</span><span>종합</span></div><strong>나를 깊이 보는<br>종합 사주상담</strong></div><div class="hdPromoBody"><b>종합 사주 상담</b><p>성격, 재물, 직업, 관계와 올해 흐름을 종합합니다.</p><div class="hdPromoPrice">9,900원 <span>상담 선택 ›</span></div></div></a></div><div class="hdPromoFill"><button type="button" data-go="input"><span>🎁</span><b>신규 회원<br>무료 기본풀이</b><small>출생정보 입력 후 바로 확인</small></button><button type="button" data-go="journal"><span>📔</span><b>상담 리포트<br>자동 저장</b><small>화담일지에서 언제든 다시 보기</small></button></div></section>`,
    );
